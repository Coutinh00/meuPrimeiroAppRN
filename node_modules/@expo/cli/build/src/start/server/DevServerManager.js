...
class DevServerManager {
   ...
   */ broadcastMessage(method, params) {
    ...
    /** Get the port for the dev server (either Webpack or Metro) that is hosting code for React Native runtimes. */ getNativeDevServerPort() {
        ...
        return ((ref = server == null ? void 0 : server.getInstance()) == null ? void 0 : ref.location.port) ?? null;
    }
    ...
    async watchEnvironmentVariables() {
        var ref;
        await ((ref = this.devServers.find((server)=>server.name === "metro")) == null ? void 0 : ref.watchEnvironmentVariables());
    }
