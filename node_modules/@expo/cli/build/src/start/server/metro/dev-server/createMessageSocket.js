...
function createClientMessageHandler(socket, clientId, clients, broadcast) {
    ...
    return (data, isBinary)=>{
        ...
        if (messageIsRequest(message)) {
            ...
            return (ref = clients.findSocket(message.target)) == null ? void 0 : ref.send((0, _socketMessages.serializeMessage)({
        ...
        if (messageIsResponse(message)) {
            var ref1;
            return (ref1 = clients.findSocket(message.id.clientId)) == null ? void 0 : ref1.send((0, _socketMessages.serializeMessage)({
