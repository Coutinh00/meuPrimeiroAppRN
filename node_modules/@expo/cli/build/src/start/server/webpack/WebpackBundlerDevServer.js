...
function assertIsWebpackDevServer(value) {
    if (!(value == null ? void 0 : value.sockWrite) && !(value == null ? void 0 : value.sendMessage)) {
        var ref;
        throw new _errors.CommandError("WEBPACK", value ? "Expected Webpack dev server, found: " + (((ref = value.constructor) == null ? void 0 : ref.name) ?? value) : "Webpack dev server not started yet.");
    }
}
