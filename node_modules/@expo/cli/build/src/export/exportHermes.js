...
function isEnableHermesManaged(expoConfig, platform) {
    switch(platform){
        case "android":
            {
                var ref;
                return (((ref = expoConfig.android) == null ? void 0 : ref.jsEngine) ?? expoConfig.jsEngine) !== "jsc";
            }
        case "ios":
            {
                var ref1;
                return (((ref1 = expoConfig.ios) == null ? void 0 : ref1.jsEngine) ?? expoConfig.jsEngine) !== "jsc";
            }
        default:
            return false;
    }
